...
USELESSWORDS=2
LOWFREQWORDS=3
for sizey in ["size100","size200","size300","size400"]:
	for modey in [SIMWORDS,USELESSWORDS]:
		for normy in [1,2]:
			...
			WEIGHT_MODE=modey
			NORMALISE=normy#1 IS MEAN, 2 IS MAX, 0 is matrix form
			...
			files=["phrasevectors-txt/"+i for i in os.listdir("/home/rs6713/Documents/finalyearprojectofficial/word2vec/trunk/phrasevectors-txt") if i.find(".txt")!=-1 and i.find(sizey)!=-1]
