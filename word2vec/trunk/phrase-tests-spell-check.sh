make
sed -e "s/’/'/g" -e "s/′/'/g" -e "s/''/ /g" < descriptions-corr.txt | tr "A-Z'_.," "a-z " > "phrase-descriptions/phrase-descriptions-corr.txt"
...
FILES=("phrase-descriptions-corr.txt" "phrase0-corr" "phrase1-corr" "phrase-descriptions-corr.txt")
