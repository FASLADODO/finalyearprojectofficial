...
sentencesRun={'mode0_norm1outvectors_phrase_win2_threshold10_size50.txt','mode0_norm1outvectors_phrase_win5_threshold50_size50.txt' }; %'all' leads to running every sentence vector
