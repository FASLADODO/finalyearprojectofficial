...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
function [dist,classLabelGal2, classLabelProb2]=autoEncodeMatches1(galFea, probFea,galClassLabel,probClassLabel, iter, options)
    threshAim=1;
   ...
   %{
    ...
    hiddenSize2= options.hiddensize2;%int16(0.5*size(sentences,4))
                ...
                softnet = trainSoftmaxLayer(features1,matchResults.','MaxEpochs',options.maxepoch3);
